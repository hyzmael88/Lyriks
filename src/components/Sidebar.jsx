...
function Sidebar() {
  ...
  return (
    ...
    <div className='absolute md:hidden block top-6 right-3'>
      {mobileMenuOpen? (
        <RiCloseLine className='w-y h-6 text-white mr-2' onClick={() =>setMobileMenuOpen(false)} />
      ): <HiOutlineMenu className='w-y h-6 text-white mr-2' onClick={() =>setMobileMenuOpen(true)} />}
    </div>
